...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senior Services, Luxury, H.E.L.P., and Guaranteed Sale programs from Jim Gladden and the Bob Lucido Team in Central Maryland." },
    ],
  }),
...
const services = [
  ...
  { icon: ShieldCheck, title: "Guaranteed Sale", desc: "Move forward with absolute certainty. If your home doesn't sell within the agreed timeframe, the Bob Lucido Team will buy it.", points: ["Written guarantee", "Defined timeframe", "Backed by team capital", "Total peace of mind"] },
];
  ...
  return (
    <div>
      ...
      <section className="py-20 container mx-auto px-6 grid md:grid-cols-2 gap-7">
        {services.map((s) => (
          <Card key={s.title} className="p-8 hover:shadow-elegant transition-smooth border-border/60">
