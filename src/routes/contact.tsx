...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Jim Gladden | Bob Lucido Team" },
    ...
    <div>
      ...
      <section className="py-20 container mx-auto px-6 grid lg:grid-cols-2 gap-10">
        <div className="space-y-5">
          <Card className="p-6 flex items-start gap-4 border-border/60">
            <div className="w-12 h-12 rounded-xl bg-gradient-gold flex items-center justify-center shrink-0"><Phone className="h-5 w-5 text-gold-foreground" /></div>
            <div>
          ...
          <Card className="p-6 flex items-start gap-4 border-border/60">
            <div className="w-12 h-12 rounded-xl bg-gradient-gold flex items-center justify-center shrink-0"><Mail className="h-5 w-5 text-gold-foreground" /></div>
            <div>
          ...
          <Card className="p-6 flex items-start gap-4 border-border/60">
            <div className="w-12 h-12 rounded-xl bg-gradient-gold flex items-center justify-center shrink-0"><MapPin className="h-5 w-5 text-gold-foreground" /></div>
            <div>
          ...
          <Card className="p-6 flex items-start gap-4 border-border/60">
            <div className="w-12 h-12 rounded-xl bg-gradient-gold flex items-center justify-center shrink-0"><Clock className="h-5 w-5 text-gold-foreground" /></div>
            <div>
